...
La adquisición se realizó mediante la librería SparkFun MAX3010x Pulse and Proximity Sensor Library, configurando el sensor con una tasa de muestreo interna de 400 Hz. El canal infrarrojo (IR) —seleccionado por ofrecer mejor penetración en el tejido que el canal rojo— se transmitió por puerto serial a 115200 baudios hacia MATLAB para su procesamiento.
